...
public class MainController {
    ...
    @RequestMapping("/0_lijstPersoneelWedde")
    public String lijstPersoneelWedde(Model model){
        model.addAttribute("personeelsleden", personeelsleden);


        return "0_lijstPersoneelWedde";
    }
...
@RequestMapping("4_welkomPersoneel")
    ...
    if(voornaam.isEmpty() || familienaam.isEmpty()  || datum.isEmpty() || weddeStr.isEmpty()){
        model.addAttribute("foutMelding", "Het formulier werd niet correct ingevuld.");
